...
class SurveyResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survey_response" do
    assert_difference('SurveyResponse.count') do
      post survey_responses_url, params: { survey_response: { response: @survey_response.response, survey_question_id: @survey_response.survey_question_id } }
    end
  ...
  test "should update survey_response" do
    patch survey_response_url(@survey_response), params: { survey_response: { response: @survey_response.response, survey_question_id: @survey_response.survey_question_id } }
